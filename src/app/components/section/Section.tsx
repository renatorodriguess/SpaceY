...
const Section = () => {
    return (
        <div className='flex flex-col justify-center bg-background-stars bg-no-repeat bg-cover bg-top-0 bg-left-0'>
            <div className='flex w-full'>
                <div className='flex items-center justify-center w-full mt-36 gap-48'>
                    <Image src={marsImg} alt='' className='w-[621px] h-[621px] '/>
